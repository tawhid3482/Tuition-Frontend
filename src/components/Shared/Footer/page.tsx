          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-6 pb-4 md:gap-64 lg:gap-80">
            ...
            <div className=" ">
              <div className="flex flex-col sm:flex-row items-center gap-2">
                <p className="text-sm text-secondary/70 mb-2 sm:mb-0">Subscribe to our newsletter:</p>
                <div className="flex">
                  <input 
                    type="email" 
                    placeholder="Your email" 
                    className="px-4 py-2 md:w-64 rounded-l-lg bg-white/10 border border-white/20 text-secondary placeholder:text-secondary/50 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent"
                  />
