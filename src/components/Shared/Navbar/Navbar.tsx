        ...
        <div className="flex justify-around items-center h-14 px-1">
          {navItems.map((item) => (
            ...
            >
              <button
                ...
                className={`flex flex-col items-center justify-center w-full h-full transition-all duration-200 relative mx-1 rounded-lg ${
                  isActive(item.name) ? " bg-primary/5" : "hover:bg-primary/5"
                }`}
              >
                <div
                  className={`relative mb-0.5 transition-transform duration-200 ${isActive(item.name) ? "-translate-y-0.5" : ""}`}
                >
                  <div
                    className={
          ...
          <div className="relative flex-1">
            <button
              ...
              className="flex flex-col items-center justify-center w-full h-full transition-all duration-200 relative mx-1 rounded-lg hover:bg-primary/5"
            >
            ...
            {isAuthenticated && bottomDropdownOpen === "profile" && (
              <div className="absolute bottom-full -left-2 -translate-x-1/2 mb-2 w-40 bg-white rounded-lg shadow-xl py-2 border border-red-600 z-50 ">
                <div className="px-4 py-2 border-b border-gray-100">
                  <p className="text-sm font-semibold text-gray-900 truncate">
                    {user?.name || "User"}
                  </p>
                ...
                <Link
                  href="/dashboard"
                  className="flex items-center px-4 py-2 text-gray-700 hover:bg-primary/5 hover:text-primary transition-all duration-200"
                  onClick={() => setBottomDropdownOpen(null)}
                >
            ...
            <div className="p-4 h-full">
              ...
              {isAuthenticated ? (
                ...
                <div className="mb-4">
                  <Link
                    href="/login"
                    className="w-full bg-primary text-white px-3 py-2.5 rounded-lg hover:bg-primary/90 transition-all duration-200 font-medium text-sm shadow-sm hover:shadow flex items-center justify-center space-x-2"
                    onClick={() => setIsOpen(false)}
                  >
                    <LogIn className="w-4 h-4" />
              ...
              {isAuthenticated && (
                <div className="mt-6 pt-4 border-t border-gray-200">
                  <Link
                    href="/dashboard"
                    className="w-full bg-primary text-white px-3 py-2.5 rounded-lg hover:bg-primary/90 transition-all duration-200 font-medium text-sm shadow-sm hover:shadow flex items-center justify-center space-x-2 mb-2"
                    onClick={() => setIsOpen(false)}
                  >
                  ...
                  <button
                    className="w-full border border-gray-300 text-gray-700 px-3 py-2.5 rounded-lg hover:bg-gray-50 transition-all duration-200 font-medium text-sm flex items-center justify-center space-x-2"
                    onClick={() => {
                      logout({});
                      setIsOpen(false);
                    }}
