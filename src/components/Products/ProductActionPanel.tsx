    ...
    <div className={compact ? "space-y-2" : "space-y-3"}>
      {showQuantitySelector ? (
        <div className="flex items-center gap-2">
          ...
          <div className="inline-flex items-center overflow-hidden rounded-lg border border-slate-300">
            ...
            <span className="min-w-10 border-x border-slate-300 px-3 py-1.5 text-center text-sm font-semibold text-primary">
              {quantity}
            </span>
            <button
              type="button"
              onClick={() => setQuantity((prev) => Math.min(normalizedMaxStock, prev + 1))}
              className="px-3 py-1.5 text-slate-700 hover:bg-slate-200 cursor-pointer"
      ...
      <div className="grid grid-cols-2 gap-2">
        <button
          ...
          className="inline-flex items-center justify-center gap-1 rounded-lg bg-primary text-secondary px-3 py-2 text-xs font-semibold transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer"
        >
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-1 rounded-lg border-2 border-slate-300 px-3 py-2 text-xs font-semibold text-slate-700 transition hover:border-primary cursor-pointer hover:text-primary disabled:cursor-not-allowed disabled:opacity-60"
        >
