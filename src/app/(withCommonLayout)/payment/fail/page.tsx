...
export default function PaymentFailPage() {
  ...
  return (
    <section className="py-10 md:py-14">
      <div className="mx-auto max-w-2xl rounded-3xl border border-rose-200 bg-white p-6 text-center shadow-sm md:p-8">
        <span className="mx-auto inline-flex h-14 w-14 items-center justify-center rounded-full bg-rose-100 text-rose-700">
          <AlertCircle className="h-7 w-7" />
        </span>
        <h1 className="mt-4 text-2xl font-bold text-slate-900">Payment Failed or Cancelled</h1>
        <p className="mt-2 text-slate-600">Your payment was not completed. You can retry from your orders page.</p>
