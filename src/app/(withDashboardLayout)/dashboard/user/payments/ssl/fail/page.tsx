...
export default function UserPaymentSslFailPage() {
  ...
  return (
    <UserDashboardShell
      title="SSL Payment Failed"
      description="The payment was cancelled or failed."
    >
      <section className="mx-auto max-w-2xl rounded-3xl border border-rose-200 bg-white p-6 text-center shadow-sm md:p-8">
        <span className="mx-auto inline-flex h-14 w-14 items-center justify-center rounded-full bg-rose-100 text-rose-700">
          <AlertCircle className="h-7 w-7" />
        </span>

        <h2 className="mt-4 text-2xl font-bold text-slate-900">Payment Failed or Cancelled</h2>
        <p className="mt-2 text-sm text-slate-600">You can retry payment from your order list.</p>
